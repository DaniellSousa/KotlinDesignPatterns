...
/*
* Design Pattern Factory Method: Para facilitar o uso e a chamada de métodos para algo específico, que não pode ser acessado
...
*
* Design Pattern Factory Method: To make it easier to use and call methods for something specific that cannot be accessed
